  ...
  if (profitTracker) {
    ...
    profitTracker.innerHTML = `
      <article class="satellite-profit-card">
        ...
        <p>The default buyer counts are model assumptions, not a waitlist or earned revenue. Related-party work is never market proof; keep first profit evidence tied to normal invoices, external buyers, the reviewed payment route, fiscal evidence, and the Sheet ledger.</p>
      </article>
    `;
  }
